...
| image::wiggins-nucleoidexclusion-drift.png[Spherocylinder Flow, 100%, title="Soft Potential", caption="", align=center]
| image::SCinner2-flow.svg[Spherocylinder Flow, 100%, title="Hard Inner Spherocylinder", caption="", align=center]
...
| image::wiggins-diffusion-B.png[title="", caption="Fig. 4B from Wiggins"]
