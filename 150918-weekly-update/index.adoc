...
image::aging_cartoon.svg["", 40%, title="", caption="", align=center]
...
_Note: Plot shown is only a cartoon._
...
image::poly_MSD.svg["", 90%, title="", caption="", align=center]

=== Example: α₂

image::poly_a2.svg["", 100%, title="", caption="", align=center]
