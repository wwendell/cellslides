...
image::hsdphi_steps_d0.001_t100_n40.svg["", 65%, title="", caption="", align=center]

=== Step Distributions

// \( \Delta \phi = 10^{-4} \)

image::hsdphi_steps_d0.0001_t100_n40.svg["", 65%, title="", caption="", align=center]

=== Step Distributions

// \( \Delta \phi = 10^{-5} \)

image::hsdphi_steps_d0.00001_t100_n40.svg["", 65%, title="", caption="", align=center]
